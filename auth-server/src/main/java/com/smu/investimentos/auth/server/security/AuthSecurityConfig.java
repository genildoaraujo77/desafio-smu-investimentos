package com.smu.investimentos.auth.server.security;

import com.smu.investimentos.auth.server.domain.UserEntity;
import com.smu.investimentos.auth.server.domain.UserRepository;
...
public class AuthSecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository(PasswordEncoder passwordEncoder,
        ...
        RegisteredClient smuuserClient = RegisteredClient
                .withId("1")
                .clientId("smuuser")
        ...
        RegisteredClient smuaccountClient = RegisteredClient
                .withId("1")
                .clientId("smuaccount")
                .clientSecret(passwordEncoder.encode("123456"))
                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)
...
//        clientRepository.save(smuuserClient);
        clientRepository.save(smuaccountClient);
